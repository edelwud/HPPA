...
long long Matrix::getRows() const { return rows; }

void Matrix::setRows(long long n) { rows = n; }

long long Matrix::getColumns() const { return columns; }

void Matrix::setColumns(long long m) { columns = m; }
...
void Matrix::print() { print(matrix, rows, columns); }
